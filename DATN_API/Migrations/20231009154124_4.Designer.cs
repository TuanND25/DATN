            ...
            modelBuilder.Entity("DATN_Shared.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd58c8fd-a214-4b7f-a383-cf55de1ce453"),
                            ConcurrencyStamp = "d08921b9-4136-4795-b83d-9aa58ee0a3cc",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("871a3f86-c01a-4458-8b32-4479749bf594"),
                            ConcurrencyStamp = "73835938-7443-444a-8802-c0abfe018165",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
