    ...
    public partial class kien : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressShips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AddressShips_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsumerPoints", x => x.UserID);
                    table.ForeignKey(
                        name: "FK_ConsumerPoints_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryConsumerPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoryConsumerPoints_ConsumerPoints_ConsumerPointId",
                        column: x => x.ConsumerPointId,
                        principalTable: "ConsumerPoints",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Transport_Fee = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoucherBills", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillItemsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_BillItems_BillItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryConsumerPoints_ConsumerPointId",
                table: "HistoryConsumerPoints",
                column: "ConsumerPointId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoryConsumerPoints_FormulaId",
                table: "HistoryConsumerPoints",
                column: "FormulaId");
