            ...
            modelBuilder.Entity("DATN_Shared.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("727e74cb-1876-4036-a7a3-d71a42ac8f15"),
                            ConcurrencyStamp = "55a9f973-a932-492e-a1f5-ed2e3c7855df",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("e9c51cc4-8d5e-4d70-8785-6d3f0db84fba"),
                            ConcurrencyStamp = "8beabc59-03c0-4953-8998-969fea11cf59",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
