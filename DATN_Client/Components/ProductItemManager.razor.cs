...
namespace DATN_Client.Components
{
    public partial class ProductItemManager
    {
        ...
        public async Task Add_PI()
        {
            ...
            await _client.PostAsJsonAsync("https://localhost:7141/api/productitem/add_productitem", _PI_VM);
            foreach (var x in _lstImg_Tam)
            {
                await _client.PostAsJsonAsync("https://localhost:7141/api/Image/Post-Image", x);
            }
            _navigation.NavigateTo("https://localhost:7075/", true);
        }
        public async Task Update_PI()
        {
            ...
            await _client.PutAsJsonAsync("https://localhost:7141/api/productitem/update_productitem", _PI_VM);
            _navigation.NavigateTo("https://localhost:7075/", true);
        }
