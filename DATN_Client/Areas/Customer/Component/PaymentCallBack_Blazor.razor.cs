	...
	public partial class PaymentCallBack_Blazor
	{
        ...
        protected override async Task OnInitializedAsync()
		{
            ...
            foreach (var x in _lstCI)
            {
                ...
                billItem_VM.Price = _pi_s_vm.CostPrice;
                billItem_VM.Status = 1;
                await _client.PostAsJsonAsync("https://localhost:7141/api/BillItem/Post-BillItem", billItem_VM);
                await _client.DeleteAsync($"https://localhost:7141/api/CartItems/delete-CartItems/{x.Id}");
            }
        }
		public async Task CLDATA()
		{
